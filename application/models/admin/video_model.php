...
class Video_model extends MY_Model {
	...
	function change($id){
		...
		if($location < $video['location']){
			$this->update(array('location' => 'location +1'),array('location >=' => $location,'location <' =>$video['location']),false);
		}
		if($location > $video['location']){
			$this->update(array('location' => 'location - 1'),array('location <=' => $location,'location >'=>$video['location']),false);
		}
	...
	function del($param){
		...
		$this->update(array('location' => 'location - 1'),array('location >' => $video['location']),false);
