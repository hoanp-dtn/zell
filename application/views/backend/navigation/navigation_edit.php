            ...
            <div class="form-group">
				...
				<div class="form-group">
                  <label>Tên menu (Tiếng Anh):</label>
					<input type="text" class="form-control" id="title_en" name="title_en" value="<?php echo set_value('title_en',$navigation['title_en']);?>" placeholder="Mời bạn nhập tên menu vào đây ">
                </div>
                <div class="form-group">
