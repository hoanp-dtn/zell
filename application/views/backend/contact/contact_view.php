<div class="content-wrapper" style="min-height: 918px;">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title" style="font-weight:bold;"><b>Danh Sách contact</b></h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            ...
            <table id="table_category" class="table table-bcontacted table-striped">
                <thead>
                  <tr>
                  ...
                  if (isset($contact)&&!empty($contact))
                  {
                    foreach ($contact as $key => $value){
						$active = '<a href = "admin/contact/changeStatus/'.$value['id'].'?redirect='.base64_encode(getCurrentUrl()).'"<button type="button" class="btn btn-default btn-sm active"><i class="fa fa-square text-green"></i></button></a>';
						$pendding = '<a href = "admin/contact/changeStatus/'.$value['id'].'?redirect='.base64_encode(getCurrentUrl()).'"<button type="button" class="btn btn-default btn-sm"><i class="fa fa-square text-red"></i></button></a>';
						...
						<li><a class ="del" href="admin/contact/del/'.$value['id'].'?redirect='.base64_encode(getCurrentUrl()).'">Xóa</a></li>
						</ul>
						</div>';
                      echo '<tr>
                              <td class=" ">'.($key+1).'</td>
        ...
        <script type="text/javascript">
		  ...
		  $("#lang").change(function(){
			  window.location.href = "admin/contact/view/"+this.value;
		  });
		  $(".del").click(function(){
