				...
				<div>
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" name = "name" class="form-control" value="<?php echo set_value('name','');?>"id="name" placeholder="tên đối tác...">
                    </div>
					<div class="form-group">
                      <label >Trang chủ đối tác</label>
                      <input type="text" name = "link" class="form-control" value="<?php echo set_value('link','');?>"id="link" placeholder="trang chủ đối tác...">
                    </div>
					<div class="form-group">
                      <label >Số điện thoại</label>
                      <input type="text" name = "phonenumber" class="form-control" value="<?php echo set_value('phonenumber','');?>"id="phonenumber" placeholder="Số điện thoại...">
                    </div>
					<div class="form-group">
                      <label >Email</label>
                      <input type="text" name = "email" class="form-control" value="<?php echo set_value('email','');?>"id="email" placeholder="email...">
                    </div>
				<div class="form-group">
					<div id="myfileupload">
