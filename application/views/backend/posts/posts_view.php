<div class="content-wrapper">
        <section class="content-header">
		  ...
		  <ol class="breadcrumb">
            ...
            <li><a href="admin/posts/view">Bài viết</a></li>
          </ol>
        </section>
        <!-- Main content -->
			...
			<?php $message_flashdata = $this->session->flashdata('message_flashdata');
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><b>Danh sách bài viết</b></h3>
                </div><!-- /.box-header -->
				<div class="box-footer clearfix">
					<form method="get" action="<?php echo $this->config->base_url().'admin/posts/view';?>">
						<input type="text" class="form-control" value="<?php echo (isset($search)&&!empty($search))?$search:'' ;?>" name="s" placeholder="Tìm kiếm bài viết ...">
						<br />
					...
					<script>
						...
						<button class="pull-right btn btn-default"><a href="admin/posts/view">Xem toàn bộ bài viết  </a><i class="fa fa-arrow-circle-right"></i></button>
                    ...
                    <tbody>
						...
						<tr>
							...
							<td>
									...
									<ul class="dropdown-menu" role="menu"> <li><a href="admin/posts/edit/<?php echo $val['id'];?>?redirect=<?php echo base64_encode(getCurrentUrl()); ?>">Sửa</a></li> 
									<li><a class ="del" href="admin/posts/recyle/<?php echo $val['id'];?>?redirect=<?php echo base64_encode(getCurrentUrl()); ?>">Xóa</a></li> <li><a class="sendpost" post-id-mail="<?=$val['id']?>" href="javascript:;">Gửi Mail Bài Viết</a></li> </ul> </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Gửi bài viết</h4>
              </div>
              ...
              <div class="modal-footer"><button type="button" class="btn btn-primary" id="sendmail">Gửi Bài Viết</button>
