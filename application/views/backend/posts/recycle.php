			...
			<?php $message_flashdata = $this->session->flashdata('message_flashdata');
              ...
              <div class="box">
				...
				<div class="box-footer clearfix">
					<form method="get" action="<?php echo $this->config->base_url().'admin/posts/recycle';?>">
